...
## Build a compact matrix for visualization

We will compute mean relative abundance per body site and genus.
...
```{r plot-heatmap-mean, fig.width=11, fig.height=4.8}
